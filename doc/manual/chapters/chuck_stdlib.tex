...
\chuckmultifunction{ string getenv ( string key );}{
returns the value of an environment variable, such as of "PATH"
}

\chuckmultifunction{ string getenv ( string key, string default\_value );}{
returns the value of an environment variable, such as of "PATH", or the provided default if the environment variable is not set.
}
